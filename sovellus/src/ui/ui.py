...
class UI:
    ...
    def start(self):
        ...
        msg1_entry = Text(self._root, width=27, height=7, font=("Helvetica 11"))
        ...
        msg2_entry = Text(self._root, width=27, height=7, font=("Helvetica 11"))
        msg3_label = ttk.Label(master=self._root, text="Purettava viesti:", font="Helvetica 13")
        msg3_entry = Text(self._root, width=27, height=7, font=("Helvetica 11"))
        decrypt_button = ttk.Button(master=self._root, text="Pura salattu viesti")
        msg4_label = ttk.Label(master=self._root, text="Purettu viesti:", font="Helvetica 13")
        msg4_entry = Text(self._root, width=27, height=7, font=("Helvetica 11"))
        ...
        msg1_entry.grid(row=4, column=0, sticky=constants.W)
        ...
        msg2_entry.grid(row=4, column=1, sticky=(constants.E, constants.W))
        msg3_label.grid(row=6, column=0, sticky=(constants.E, constants.W), padx=5, pady=5)
        msg3_entry.grid(row=7, column=0, sticky=constants.W)
        ...
        msg4_entry.grid(row=7, column=1, sticky=(constants.E, constants.W))
